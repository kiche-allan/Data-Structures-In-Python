...
exports.getStyledImportInsertion = exports.getImportInsertion = void 0;
function getImportInsertion(existingText, importPath, modulesToImport) {
    ...
    if (importAlreadyPresent) {
        ...
        return {
            insertionText: `import { ${modulesToImport.join(', ')} } from "${importPath}"\n`,
            insertionOffset: 0,
        };
    }
}
exports.getImportInsertion = getImportInsertion;
function getStyledImportInsertion(existingText) {
...
exports.getStyledImportInsertion = getStyledImportInsertion;
